...
export const setTotalUsersCountAC = (totalUsersCount) => ({type: setTotalUsersCount, totalUsersCount: totalUsersCount})
...
export const getUsersThunkCreator = (pageSize, currentPage) => (dispatch) => {
    ...
    usersAPI.orderByKey().startAt(`3`).limitToFirst(pageSize).on('value', (snap) => {
