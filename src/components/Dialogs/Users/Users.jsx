...
if(props.users.length===0){
    ...
    return <div>
            {
                props.users.map(u=><div className={s.user__card}>
                    <div className={s.user__avatar}>
                        <img src={u.photo} />
                        <div>
                            {u.followed
                                ?<button onClick={()=>{props.unFollow(u.id)}} className={s.unfollow__btn}>UNFOLLOW</button>
                                :<button onClick={()=>{props.follow(u.id)}} className={s.follow__btn}>FOLLOW</button>
                            }
                        </div>
                    </div>
